...
public class UsuarioService implements CRUDOperation<UsuarioDTO> {
	...
	private void enviarCorreoBienvenida(UsuarioDTO data) {
		try {
			...
			System.err.println("No se pudo enviar el correo de bienvenida a "
					+ data.getCorreo() + ": " + e.getMessage());
		}
	}
